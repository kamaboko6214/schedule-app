...
export default function SignupPage() {
  ...
  const passwordStrength = (pw: string) => {
    ...
    if (pw.length < 8) return { label: "弱い", color: "bg-red-400", width: "w-1/3" }
    if (pw.length < 12 || !/[0-9]/.test(pw) || !/[a-z]/i.test(pw)) return { label: "普通", color: "bg-yellow-400", width: "w-2/3" }
    return { label: "強い", color: "bg-emerald-400", width: "w-full" }
  }
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 px-8 py-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">無料ではじめましょう</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className={`w-full pl-10 pr-10 py-2.5 rounded-xl border outline-none transition-all text-sm text-gray-900 placeholder-gray-400 focus:ring-2 ${
              ...
              {confirmPassword && password !== confirmPassword && (
                <p className="mt-1.5 text-xs text-red-500">パスワードが一致していません</p>
              )}
            </div>
